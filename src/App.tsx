...
function PortfolioContent() {
  ...
  return (
    <div className="min-h-screen bg-[#FBFBFA] text-zinc-800 flex flex-col font-sans selection:bg-indigo-500/10 selection:text-indigo-900">
      ...
      {/* Footer */}
      <footer className="border-t border-zinc-200/80 bg-zinc-50/50 py-12 text-zinc-500 text-xs">
